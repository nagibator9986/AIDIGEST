...
WELCOME_GROUP = (
    ...
    "маркетинговый шум.\n\n"
    "📅 Доставка <b>дважды в неделю</b>: {days} в <b>{time}</b> ({tz}). "
    "Между этими двумя выпусками я молчу.\n\n"
    ...
    "• /digest_topic — закрепить текущую тему форума для дайджеста\n"
    "• /digest_now — прислать дайджест сейчас\n\n"
    "Права администратора мне не нужны — достаточно возможности писать."
)

START_PRIVATE = (
    "👋 Привет! Я <b>AI Insight Digest</b> — дайджест значимых новостей из "
    "мира искусственного интеллекта.\n\n"
    "Добавьте меня в групповой чат — и туда <b>дважды в неделю, в понедельник "
    "и в пятницу утром</b>, будет приходить подборка топ-новостей AI, "
    "отобранных и прокомментированных ИИ-редактором. Расписание настраивается "
    "прямо в чате командой /settings.\n\n"
...
HELP = (
    ...
    "📅 По умолчанию — <b>дважды в неделю: в понедельник и в пятницу утром</b>. "
    "Ничего вне этого расписания не приходит.\n\n"
    ...
    "• /digest_topic — отправлять дайджест в текущую тему форума\n"
...
DIGEST_TOPIC_USAGE = (
    "Откройте нужную тему форума и отправьте там <code>/digest_topic</code>.\n"
    "Чтобы вернуть отправку в основной чат: <code>/digest_topic off</code>."
)
DIGEST_TOPIC_OK = "✅ Готово. Теперь дайджест будет приходить в эту тему."
DIGEST_TOPIC_RESET = "✅ Готово. Теперь дайджест будет приходить в основной чат."
