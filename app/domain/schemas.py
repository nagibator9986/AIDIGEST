...
class GeminiVerdict(BaseModel):
    ...
    score: int = Field(
        ...
        description=(
            ...
            "Используй всю шкалу: релиз модели нового поколения или "
            "историческое событие индустрии — это 9–10, а не 8. Не занижай "
            "из осторожности, если reasoning указывает на крупное событие."
        ),
    )
